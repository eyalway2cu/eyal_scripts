// Configuration
const buttonSelectors = ["#whatever", ".modal-button"]; // Can be a string or an array of selectors
const webhook = "XXXX";
...
function openModal(event) {
    ...
    document.getElementById('message').style.display = 'none'; // Hide previous messages
    document.getElementById('phoneNumber').focus(); // Focus on the input field
}
...
function submitPhoneNumber(event) {
    ...
    xhr.send("phoneNumber=" + encodeURIComponent(phoneNumber) + "&sid=" + encodeURIComponent(sid));
}
